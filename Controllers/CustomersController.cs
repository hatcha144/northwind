    ...
    public class CustomersController : Controller
    {
        ...
        public ActionResult Index(string option, string search)
        {
            ...
            if (option == "CompanyName")
            {
                ...
                return View(db.Customers.Where(x=> x.CompanyName.Contains(search) || search == null).ToList());
            }
            else if (option == "ContactName")
            {
                return View(db.Customers.Where(x=> x.ContactName.StartsWith(search) || search == null).ToList());
            }
            else if (option == "Country")
            {
                return View(db.Customers.Where(x => x.Country.StartsWith(search) || search == null).ToList());
            }
            else
            {
                return View(db.Customers.Where(x=> x.City.StartsWith(search) || search == null).ToList());
            }
